...
namespace HomeWork9.Классы
{
    class MyGame : IGame
    {
        ...
        public void Play(List<Team> teams)
        {
            ...
            Console.WriteLine("Начинается игра <<Квиз>");
            Console.WriteLine($"Лидируюшая команда-<<{teams[rand1].team}>>, команада <<{teams[rand2].team}>> пока позади. К чему же приведет эта схватка??");
